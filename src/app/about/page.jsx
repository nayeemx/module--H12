...
const Page = () => {
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20  bg-emerald-800:py-12  bg-emerald-800:px-6 py-9 px-4 bg-gradient-to-b from-slate-500 to-slate-800">
      <p className="font-normal text-sm leading-3 pb-2">About</p>
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-zinc-100 mt-6">
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-amber-100 mt-6">
            Founded
          </p>
          <p className="font-normal text-base leading-6 text-amber-100 mt-6">
            It is a long established fact that a reader will be distracted by
      ...
      <div className="flex lg:flex-row flex-col  bg-emerald-800:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-amber-100">
            Our Mission
          </h2>
          <p className="font-normal text-base leading-6 text-amber-100 mt-6 w-full lg:w-10/12 xl:w-9/12">
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
            by this our present charter confirmed for us and our heirs forever
          ...
          <p className="font-normal text-base leading-6 text-amber-100 w-full lg:w-10/12 xl:w-9/12 mt-10">
            It is a long established fact that a reader will be distracted by
            the readable content of a page when looking at its layout. The point
            of using Lorem Ipsum.In the first place we have granted to God, and
            by this our present charter confirmed for us and our heirs forever
        ...
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            {/* <!-- Team Card --> */}
            <div className="flex p-4 shadow-md bg-emerald-800">
              <div className="mr-6">
                <svg
                  className="mr-6"
                  width="36"
              ...
              <div className="">
                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-amber-100">
                  Team
                </p>
                <p className="mt-2 font-normal text-base leading-6 text-amber-100">
            ...
            {/* <!-- Board Card --> */}
            <div className="flex p-4 shadow- bg-emerald-800">
              <div className="mr-6">
                <svg
                  width="36"
                  height="36"
